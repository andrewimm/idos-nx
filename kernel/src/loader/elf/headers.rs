...
pub struct ElfHeader {
    ...
    bit_class: u8,
    /// 1 indicates little-endian, 2 indicates big-endian for all header fields
    endian: u8,
...
pub struct ProgramHeader {
    ...
    pub segment_virtual_address: VirtualAddress,
...
pub struct SectionHeader {
    ...
    pub section_virtual_address: VirtualAddress,
