...
/// remain stable.
/// This data structure is used in many of the internal concepts where items
/// are indexed by a numeric handle, like filesystems and devices.
