/// Standard VGA 256-color palette, stored as 0x00RRGGBB.
/// The first 16 entries are the classic CGA/EGA colors. Entries 16-231 are a
/// 6x6x6 color cube, and 232-255 are a grayscale ramp. This matches the
/// default palette loaded by VGA BIOS at mode 0x13.
///
/// In the future, programs can supply a custom palette to enable VGA-style
/// palette rotation and other effects.
pub static VGA_PALETTE: [u32; 256] = [
    ...
    0xAFFF00, 0xAFFF5F, 0xAFFF87, 0xAFFFAF, 0xAFFFF7, 0xAFFFFF,
