...
const REGION_TYPE_FREE: u32 = 1;
const REGION_TYPE_RESERVED: u32 = 2;
const REGION_TYPE_ACPI_RECOVERABLE: u32 = 3;
const REGION_TYPE_ACPU_NVS: u32 = 4;
const REGION_TYPE_BAD: u32 = 5;
