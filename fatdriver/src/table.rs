...
impl AllocationTable {
    ...
    pub fn get_next_cluster<D: DiskIO>(&self, cluster: u32, disk: &mut DiskAccess<D>) -> Option<u32> {
    ...
    pub fn get_nth_cluster<D: DiskIO>(
        &self,
        first_cluster: u32,
        index: u32,
    ...
    pub fn set_cluster_entry<D: DiskIO>(&self, cluster: u32, value: u32, disk: &mut DiskAccess<D>) {
    ...
    pub fn allocate_cluster<D: DiskIO>(&self, disk: &mut DiskAccess<D>) -> Option<u32> {
    ...
    pub fn free_chain<D: DiskIO>(&self, first_cluster: u32, disk: &mut DiskAccess<D>) {
        let mut current = first_cluster;
        loop {
